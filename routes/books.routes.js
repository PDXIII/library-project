...
router.get("/books/:id/edit", isUserLoggedIn, (req, res, next) => {
  const data = {};
...
router.post("/books/:id/edit", isUserLoggedIn, (req, res, next) => {
...
router.post("/books/:id/delete", isUserLoggedIn, (req, res, next) => {
